    ...
    return (
        <div className="flex flex-wrap justify-center mb-4">
            <div className='mb-4 cursor-pointer'>
                <h2 className='text-custom-purple-1 text-base font-medium mb-4'>¿Necesita ayuda?</h2>
                <div className="flex">
                    <svg className='self-center' width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='max-w-[14rem] text-[#707070] text-base leading-5 font-medium ml-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            </div>
            <div className='mb-4 cursor-pointer'>
                <h2 className='text-custom-purple-1 text-base font-medium mb-4'>¿Por qué registrarse?</h2>
                <div className="flex">
                    <svg className='self-center' width="45" height="41" viewBox="0 0 45 41" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='mb-4 cursor-pointer'>
                <h2 className='text-custom-purple-1 text-base font-medium mb-4'>¿Qué está pensando?...</h2>
                <div className="flex">
                    <svg className='self-center' width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
